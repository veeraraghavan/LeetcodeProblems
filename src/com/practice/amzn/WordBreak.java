...
public class WordBreak {
    public static void main(String[] args) {
        ...
        System.out.println(me.wordBreak2("aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaab",dict));
    ...
    public boolean wordBreakrecurse(String s, HashMap<String, Boolean> wordMap, int index, Boolean[] exists) {
        if (index == s.length())
            return true;
