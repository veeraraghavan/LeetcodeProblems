...
public class UTFEncoding {
    ...
    public int getLeadingOne(int num){
        int temp = num;
        int result = 0;
        int counter=1;
        while(num>0){
            if(num-(128/counter)>=0){
                num-=(128/counter);
                result++;
                counter*=2;
            }else{
